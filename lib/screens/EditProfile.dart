...
class EditProfile extends CompleteProfile {
  final UserModel userModel;
  final User firebaseUser;

  const EditProfile({super.key, required this.userModel, required this.firebaseUser}) : super(userModel: userModel,firebaseUser: firebaseUser);
          ...
          child: ListView(
            children: [
              ...
              TextField(
                ...
                onChanged: (value) {
                  ref.watch(userProvider.notifier).updateUserName(value);
                },
              ),
              SizedBox(height: 20),
              CupertinoButton(
